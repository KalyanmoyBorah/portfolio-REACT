...
import Abouts from "../../Utils/Data/About";
  ...
  return (
    <div className="about">
      ...
      <div className="header">
        ...
        <img
          alt="logo"
          src={require(`../../Utils/images/Myimages/kmb.jpg`)}
      ...
      <div className="images">
        <div className="up">
          <div className="upinside">
            <img
              alt="logo"
              src={require(`../../Utils/images/Myimages/kmb1.jpg`)}
          ...
          <div className="upinside">
            <img
              alt="logo"
              src={require(`../../Utils/images/Myimages/kmb5.jpg`)}
              className="collageimage"
            ></img>
          </div>
          <div
          ...
          >
            <div style={{ flex: 1, display: "flex" }}>
              <div style={{ flex: 1 }}>
                <img
                  alt="logo"
                  src={require(`../../Utils/images/Myimages/kmb3.jpg`)}
              ...
              <div style={{ flex: 1 }}>
                <img
                  alt="logo"
                  src={require(`../../Utils/images/Myimages/kmb4.jpg`)}
                  className="smallimage"
                ></img>
              </div>
            </div>
            <div style={{ flex: 1, display: "flex" }}>
              <div style={{ flex: 1 }}>
                <img
                  alt="logo"
                  src={require(`../../Utils/images/Myimages/kmb2.jpg`)}
                  className="smallimage"
                ></img>
              </div>
              <div style={{ flex: 1 }}>
                <img
                  alt="logo"
                  src={require(`../../Utils/images/Myimages/kmb7.jpg`)}
                  className="smallimage"
                ></img>
              </div>
            </div>
          ...
          <div className="upinside">
            <img
              alt="logo"
              src={require(`../../Utils/images/Myimages/kmb13.jpg`)}
              className="collageimage"
            ></img>
          </div>
        </div>
        <div className="down">
          <div className="upinside">
            <img
              alt="logo"
              src={require(`../../Utils/images/Myimages/kmb8.jpg`)}
              className="collageimage"
            ></img>
          </div>
          <div
          ...
          >
            <div style={{ flex: 1 }}>
              <img
                alt="logo"
                src={require(`../../Utils/images/Myimages/kmb6.jpg`)}
                className="collageimage"
              ></img>
            </div>
            <div style={{ flex: 1, display: "flex" }}>
              <div style={{ flex: 1 }}>
                <img
                  alt="logo"
                  src={require(`../../Utils/images/Myimages/kmb10.jpg`)}
                  className="smallimage"
                ></img>
              </div>
              <div style={{ flex: 1 }}>
                <img
                  alt="logo"
                  src={require(`../../Utils/images/Myimages/kmb11.jpg`)}
                  className="smallimage"
                ></img>
              </div>
            </div>
          ...
          <div className="upinside">
            <img
              alt="logo"
              src={require(`../../Utils/images/Myimages/kmb9.jpg`)}
              className="collageimage"
            ></img>
          </div>
          <div className="upinside">
            <img
              alt="logo"
              src={require(`../../Utils/images/Myimages/kmb12.jpg`)}
              className="collageimage"
            ></img>
          </div>
        </div>
